...
def update_a_student_data(student_id, student_data):
    student_to_upadte = get_a_student_by_id(student_id)
    student_to_upadte.name = student_data["name"]
    student_to_upadte.age = student_data["age"]
    student_to_upadte.registration_no = student_data["registration_no"]
    local_session.commit()
